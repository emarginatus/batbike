...
leaflet() %>%
  ...
  addLayersControl(
    baseGroups = c("OpenCycleMap", "OpenStreetMap"),
    overlayGroups = c(
      "maximaal bewegwijzerd", "aanbevolen", "knooppunt", "object", "transport", "infopunt"
    ),
    options = layersControlOptions(collapsed = FALSE)
  ) %>%
  hideGroup(c("maximaal bewegwijzerd", "knooppunt", "object"))
```
